...
bool KdSpriteShader::Init()
{
	...
	spriteBatch = new DirectX::SpriteBatch(KdDirect3D::Instance().GetDevContextss());
	 
	spriteFont = new DirectX::SpriteFont(KdDirect3D::Instance().GetDevss(), L"Asset/Font/Kabutochou16.spritefont"); //newFont04 Kabutochou16
	spriteFont2 = new DirectX::SpriteFont(KdDirect3D::Instance().GetDevss(), L"Asset/Font/Rounded.spritefont"); //fontTooMuchInk , newFont04
