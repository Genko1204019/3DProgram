...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdCamera::SetProjectionMatrix(float fov, float maxRange, float minRange, float aspectRatio, float twistAngle)
{
	...
	// Create a twist rotation matrix around the Z axis
	Matrix twistMat = DirectX::XMMatrixRotationZ(twistAngle);
	// Apply the twist matrix to the projection matrix
	m_mProj = twistMat * m_mProj;
