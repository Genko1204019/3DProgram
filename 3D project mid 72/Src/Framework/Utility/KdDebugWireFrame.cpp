...
void KdDebugWireFrame::AddDebugSphereByType(KdCollider::SphereInfo& _sphereObj, Math::Color _sphereColor)
{
	AddDebugSphere(_sphereObj.m_sphere.Center, _sphereObj.m_sphere.Radius, _sphereColor);

}

void KdDebugWireFrame::AddDebugLineByType(KdCollider::RayInfo& _rayObj, Math::Color _rayColor)
{
	AddDebugLine(_rayObj.m_pos, _rayObj.m_pos + _rayObj.m_dir * _rayObj.m_range, _rayColor);
}
