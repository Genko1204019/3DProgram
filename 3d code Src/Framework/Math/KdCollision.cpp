...
{
	//------------------------------------------
	// ブロードフェイズ //mean broad phase: この段階でヒットしていないなら、詳細な判定をする必要なし
	...
	//------------------------------------------
	// ナローフェイズ //mean narrow phase : この段階でヒットしているなら、詳細な判定をする必要あり
	// 　球とメッシュとの詳細判定
	//------------------------------------------
