...
public:
	// デフォルトの射影行列を作成
	KdCamera() { SetProjectionMatrix(60.0f); } //default 60
	...
	// 射影行列の設定
	void SetProjectionMatrix(float fov, float maxRange = 2000, float minRange = 0.01f, float aspectRatio = 0.0f, float twistAngle = 0);
